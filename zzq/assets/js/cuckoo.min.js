...
prefercolor();
var ook = 'copy';
var patt = /Theme <a(.*) href="http:\/\/chenqicong\.cf"(.*)>Touji<\/a> By <a(.*) href="http:\/\/chenqicong\.cf"(.*)>ChenQiCong<\/a>/i;
paceOptions = {
    ajax: false
};
...
console.log(" %c \u89e3\u5fe7\u5de5\u5177\u7bb1 %c \u0042\u0079\u0020\u0043\u0068\u0065\u006e\u0051\u0069\u0043\u006f\u006e\u0067\u0020\u007c\u0020\u0068\u0074\u0074\u0070\u003a\u002f\u002f\u0063\u0068\u0065\u006e\u0071\u0069\u0063\u006f\u006e\u0067\u002e\u0063\u0066\u002f", "color: #FFFFFF; background: #FF4081; padding:6px;", "color: #FFFFFF; background: #424242; padding:6px;");
$(document).on('pjax:complete',
function() {
    NProgress.done();
    mdui.mutation();
