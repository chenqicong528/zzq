...
function Footer(){
  ...
  echo $footer.'<p>&copy; '.date("2019-Y").' <a href="http://chenqicong.cf" target="_blank">解忧工具箱</a> All Rights Reserved By <a href="http://chenqicong.cf" target="_blank">ChenQiCong</a></a>'.$content.'<br><br><span id="cuckoo-copy">Theme <a href="http://chenqicong.cf" target="_blank">解忧工具箱</a> By <a href="http://chenqicong.cf" target="_blank">ChenQiCong</a>｜Powered By <a href="http://www.typecho.org" target="_blank">Typecho</a></span></p>';
}
