...
<div class="mdui-drawer mdui-drawer-close mdui-drawer-full-height drawer">
  ...
  <div class="drawer-bottom mdui-typo">
    ...
    <div>Theme <a href="https://github.com/bhaoo/Cuckoo" target="_blank">解忧工具箱</a> By <a href="https://dwd.moe" target="_blank">ChenQiCong</a></div>
  </div>
</div>
  ...
  <div class="setting-card">
    ...
    <div class="mdui-card-media-covered">
      <div class="mdui-card-primary">
        <div class="mdui-card-primary-title">欢迎使用</div>
      </div>
    </div>
  </div>